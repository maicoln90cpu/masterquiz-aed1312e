...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { videoId }: ConfirmRequest = await req.json();
    ...
    console.log(`Confirming TUS upload for video: ${videoId}, user: ${user.id}`);
    ...
    console.log(`TUS upload confirmed for video: ${videoId}`);
    ...
    console.error('TUS confirm error:', error);
