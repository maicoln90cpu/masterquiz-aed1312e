...
- **Backend**: Supabase (PostgreSQL + RLS + 65 Edge Functions + Auth + Storage)
...
| Edge Functions | `supabase/functions/` (65 funções) |
...
| [EDGE_FUNCTIONS.md](./EDGE_FUNCTIONS.md) | Catálogo das 65 funções |
