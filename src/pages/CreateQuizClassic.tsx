...
/**
 * CreateQuizClassic — Full Classic editor layout.
 * Extracted from the original CreateQuiz to prevent duplicate hook instances
 * when the Modern layout is active.
 */
const CreateQuizClassic = () => {
...
export default CreateQuizClassic;
