...
// Se aumentar, o teste falha. Se diminuir, ATUALIZE este número (libera o aperto).
// Para descobrir o valor real, rode o teste e veja "Total: X" na saída.
const MAX_VIOLATIONS_ALLOWED = 200;
