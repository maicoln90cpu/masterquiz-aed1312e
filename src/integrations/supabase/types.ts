  ...
  public: {
    Tables: {
      ab_test_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "ab_test_sessions_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "ab_test_sessions_variant_id_fkey"
            columns: ["variant_id"]
            isOneToOne: false
            referencedRelation: "quiz_variants"
            referencedColumns: ["id"]
          },
        ]
      }
      ai_quiz_generations: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_quiz_generations_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: false
            referencedRelation: "quizzes"
            referencedColumns: ["id"]
      ...
      bunny_videos: {
        ...
        Relationships: [
          {
            foreignKeyName: "bunny_videos_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: false
            referencedRelation: "quizzes"
            referencedColumns: ["id"]
      ...
      custom_form_fields: {
        ...
        Relationships: [
          {
            foreignKeyName: "custom_form_fields_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: false
            referencedRelation: "quizzes"
            referencedColumns: ["id"]
      ...
      integration_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "integration_logs_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: false
            referencedRelation: "quizzes"
            referencedColumns: ["id"]
      ...
      landing_ab_sessions: {
        ...
        Relationships: [
          {
            foreignKeyName: "landing_ab_sessions_test_id_fkey"
            columns: ["test_id"]
            isOneToOne: false
            referencedRelation: "landing_ab_tests"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      quiz_form_config: {
        ...
        Relationships: [
          {
            foreignKeyName: "quiz_form_config_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: true
            referencedRelation: "quizzes"
            referencedColumns: ["id"]
      ...
      quiz_responses: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "quiz_responses_variant_id_fkey"
            columns: ["variant_id"]
            isOneToOne: false
            referencedRelation: "quiz_variants"
            referencedColumns: ["id"]
      ...
      quiz_step_analytics: {
        ...
        Relationships: [
          {
            foreignKeyName: "quiz_step_analytics_question_id_fkey"
            columns: ["question_id"]
            isOneToOne: false
            referencedRelation: "quiz_questions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "quiz_step_analytics_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: false
            referencedRelation: "quizzes"
            referencedColumns: ["id"]
      ...
      quiz_tag_relations: {
        ...
        Relationships: [
          {
            foreignKeyName: "quiz_tag_relations_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: false
            referencedRelation: "quizzes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "quiz_tag_relations_tag_id_fkey"
            columns: ["tag_id"]
            isOneToOne: false
      ...
      quiz_variants: {
        ...
        Relationships: [
          {
            foreignKeyName: "quiz_variants_parent_quiz_id_fkey"
      ...
      recovery_blacklist: {
        ...
        Relationships: [
          {
            foreignKeyName: "recovery_blacklist_added_by_fkey"
            columns: ["added_by"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "recovery_blacklist_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      recovery_campaigns: {
        ...
        Relationships: [
          {
            foreignKeyName: "recovery_campaigns_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recovery_campaigns_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
      ...
      recovery_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "recovery_templates_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      validation_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "validation_requests_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: false
            referencedRelation: "quizzes"
            referencedColumns: ["id"]
      ...
      video_analytics: {
        ...
        Relationships: [
          {
            foreignKeyName: "video_analytics_quiz_id_fkey"
            columns: ["quiz_id"]
            isOneToOne: false
            referencedRelation: "quizzes"
            referencedColumns: ["id"]
          },
          {
            ...
            columns: ["video_id"]
            isOneToOne: false
            referencedRelation: "bunny_videos"
            referencedColumns: ["id"]
          },
        ]
      }
